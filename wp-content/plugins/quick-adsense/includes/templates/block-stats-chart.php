...
<div id="quick_adsense_ad_stats_chart_wrapper">
	...
	<textarea id="quick_adsense_ad_stats_chart_data" style="display: none;"><?php echo esc_textarea( quick_adsense_get_value( $quick_adsense_template_args, 'stats_data' ) ); ?></textarea>
