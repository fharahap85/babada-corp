		...
		<p class="quick_adsense_widget_adunits_styling_controls">
			...
			echo wp_kses(
				quickadsense_get_control(
					...
					quick_adsense_get_value( $quick_adsense_template_args, 'widget_enable_global_style' ),
					null,
					'input',
					'margin: -3px 10px 0 0;'
				),
			...
			echo wp_kses(
				quickadsense_get_control(
					...
					quick_adsense_get_value( $quick_adsense_template_args, 'widget_global_alignment' ),
			...
			echo wp_kses(
				quickadsense_get_control(
					...
					quick_adsense_get_value( $quick_adsense_template_args, 'widget_global_margin' ),
					null,
					'input',
	...
	<div id="quick_adsense_widget_adunits_wrapper">
		<div id="quick_adsense_widget_adunits_initial_wrapper">
			...
			for ( $quick_adsense_i = 1; $quick_adsense_i <= 3; $quick_adsense_i++ ) {
				...
				echo quick_adsense_load_file( 'templates/adunit-widget.php', $quick_adsense_template_args );
				// phpcs:enable
			}
			?>
		</div>
